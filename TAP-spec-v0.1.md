...
**Status:** Draft · **Version:** 0.1.2 · **Date:** 2026-07-30
...
```jsonc
{
  ...
  // parent_event_id and policy_decision are OMITTED here because this Event has
  // neither. They are NOT sent as null — see the omit rule below.
...
| envelope | `evidence`, `action_ref`, `parent_event_id`, `policy_decision`, `decision`, `checkpoint` | OPTIONAL — omit when absent |
...
## 9. Policy Decisions (Record Format) · `[TAP-POLICY-RECORD]`
